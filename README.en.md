...
| Agent                                                     | Support | Notes                                             |
|-----------------------------------------------------------|---------|---------------------------------------------------|
| [Caret/Cline (compatible)](https://github.com/aicoding-caret/spec-kit) | ✅ | Supports `.caretrules`, `.clinerules`, and custom brand rules. |
...
| `--ai`                 | Option   | AI assistant to use: `cline`, `claude`, `gemini`, `copilot`, `cursor`, `qwen`, `opencode`, `codex`, `windsurf`, `kilocode`, `auggie`, or `roo` |
...
# Initialize with Caret/Cline compatible template
specify init my-project --ai cline
# This will prompt you to choose between .clinerules, .caretrules, or a custom brand.
